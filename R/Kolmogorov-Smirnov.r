...
ks1 <- object_ks$statistic
p_value1 <- object_ks$p.value

### 2da ###

# Se simulará con las muestras anteriores un DataFrame de dos columnas. Una de ellas contendrá 2 clases (1 y 0),
